...
import com.atchen.swiftmall.common.exception.GuiguException;
import com.atchen.swiftmall.manager.listener.ExcelListener;
import com.atchen.swiftmall.manager.mapper.CategoryMapper;
import com.atchen.swiftmall.manager.service.CategoryService;
...
//                categoryExcelVo.setId(id);
            ...
            EasyExcel.write(response.getOutputStream(), CategoryExcelVo.class)
                    .sheet("Categorized_data").doWrite(categoryExcelVoList);
        } catch (Exception e) {
            e.printStackTrace();
